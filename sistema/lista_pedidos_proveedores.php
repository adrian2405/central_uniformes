    ...
    <br><br><br><br><br>
        ...
        <table id="pedidos" class="table-striped table-hover">
            <thead class="text-center">
                ...
                <th>Fecha Entrega</th>
                <th>Observaciones</th>
                <th><select name="catpend" id="catpend" class="form-control">
        ...
        $(document).ready(function() {
            ...
            function load_data(pend) {
                var dataTable = $('#pedidos').DataTable({
                    ...
                    "order": [],
                    "ajax": {
                        url: "server-side-pedidos-proveedores.php",
                        type: "POST",
                        data: {
                            pend: pend
                        }
            ...
            $(document).on('change', '#catpend', function() {
                var catpend = $(this).val();
